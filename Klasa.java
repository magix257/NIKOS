...
public class Klasa extends JFrame implements ActionListener {
	...
	String[] wyrazy = {"mama", "tata", "siostra", "brat", "dziadek", "babcia", "wujek", "ciocia", "auto", "samochód", "kwiatek", "drzewo", "rower", "bramka", "pi³ka", "kolega", "œniadanie", "kolacja", "obiad", "podwieczorek", "wiosna", "lato", "jesieñ", "zima", "styczeñ", "luty", "marzec", "kwiecieñ", "maj","czerwiec", "lipiec", "sierpieñ", "wrzesieñ", "paŸdziernik", "listopad", "grudzieñ", "poniedzia³ek", "wtorek", "œroda", "czwartek", "pi¹tek", "sobota", "niedziela", "urodziny", "imieniny"};
